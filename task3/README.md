...
В первой строке задано однр натуральное число *n* (*2 &le; n &le; 10<sup>5</sup>*) - число дней, за которые у вас есть.
Во второй строке заданы *n* чисел *a<sub>i</sub>* - число подключенных/отмененных подписок за *i*-й день (*1 &le; i &le; n, 1 &le; a<sub>i</sub> &le; 10<sup>3</sup>*).
